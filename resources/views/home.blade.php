<x-layout>
    ...
    <div class="container-fluid backgroundVinile ">
        <div class="row justify-content-center">
            <div class="col-md-4 d-lg-block d-none p-0 " data-aos="fade-right" data-aos-duration="1500">
                ...
                <div class="col-8 p-0 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <a class="button-74 mb-3 p-1 mb-lg-0" href="{{ route('announcement.create')}}">{{ __('ui.Crea annuncio') }}</a>
                </div>
        </div>
    </div>
